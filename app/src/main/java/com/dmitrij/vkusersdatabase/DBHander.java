...
class DBHandler extends SQLiteOpenHelper{
    ...
    @Override public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + TABLE_NAME + " ("+ ID_COL +" INTEGER PRIMARY KEY AUTOINCREMENT," + NAME_COL + " TEXT," + LASTNAME_COL + " INTEGER" + ");";
        db.execSQL(query);
    }
    ...
    public void insertRecord(String name, String lastname){
